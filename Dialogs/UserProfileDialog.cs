    ...
    public class UserProfileDialog : ComponentDialog
    {
        ...
        private static async Task<DialogTurnResult> GetCityOrTemp(WaterfallStepContext stepContext, CancellationToken cancellationToken)
        {
            ...
            else
            {
                ...
                {
                    model.Temp = j.SelectToken("main").SelectToken("temp").ToString();
                    return await stepContext.PromptAsync(nameof(ChoicePrompt),
                    new PromptOptions
                    {
        ...
        {
            // WaterfallStep finisce sempre con la fine della cascata o con un'altra finestra di dialogo; qui è una finestra di dialogo prompt.
            // L'esecuzione di un prompt qui significa che il prossimo WaterfallStep verrà eseguito quando verrà ricevuta la risposta dell'utente.
            return await stepContext.PromptAsync(nameof(ChoicePrompt),
                new PromptOptions
                {
